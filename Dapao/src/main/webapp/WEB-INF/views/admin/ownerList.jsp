		...
		<div class="modal-content">
			...
			<div class="modal-body" id="ownInfo">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="own_pw"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">사업자 이름</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="own_name"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">사업자 전화번호</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="own_tel"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">사업자 이메일</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="own_email"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">사업자 상태</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="own_state"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">ent_name</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ent_name"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">ent_cate</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ent_cate"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">ent_addr</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ent_addr"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">ent_mo</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ent_mo"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">ent_file</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ent_file"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">ent_of</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ent_of"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">ent_notice</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ent_notice"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">ent_info</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ent_info"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">ent_img</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ent_img"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">ent_ot</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ent_ot"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">ent_ct</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ent_ct"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">ent_account</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ent_account"><br>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">ent_stop</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ent_stop"><br>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$(".update").click(function(){
				$.ajax({
					url : "/admin/ownerInfoUpdate",
					data : {
						"own_id" : $('input[name=own_id]').val(),
						"own_name" : $('input[name=own_name]').val(),
						"own_pw" : $('input[name=own_pw]').val(),
						"own_tel" : $('input[name=own_tel]').val(),
						"own_email" : $('input[name=own_email]').val(),
						"own_state" : $('input[name=own_state]').val(),
						"ent_name" : $('input[name=ent_name]').val(),
						"ent_cate" : $('input[name=ent_cate]').val(),
						"ent_addr" : $('input[name=ent_addr]').val(),
						"ent_mo" : $('input[name=ent_mo]').val(),
						"ent_file" : $('input[name=ent_file]').val(),
						"ent_of" : $('input[name=ent_of]').val(),
						"ent_notice" : $('input[name=ent_notice]').val(),
						"ent_info" : $('input[name=ent_info]').val(),
						"ent_img" : $('input[name=ent_img]').val(),
						"ent_ot" : $('input[name=ent_ot]').val(),
						"ent_ct" : $('input[name=ent_ct]').val(),
						"ent_account" : $('input[name=ent_account]').val(),
						"ent_stop" : $('input[name=ent_stop]').val()
					},
					dataType : "json",
					success : function(data) {
						console.log(data)
