...
public class AdminController {
   ...
   public UserVO userInfo(@RequestParam("us_id") String us_id) throws Exception{
	...
	// 사업자 정보수정
	@RequestMapping(value = "/ownerInfoUpdate", method = RequestMethod.GET)
	public void ownerInfoUpdateGET(EntVO vo) throws Exception{
		logger.debug("ownerInfoUpdateGET() 호출");
		aService.ownerInfoUpdate(vo);
	}
   ...
   public int userInfoUpdate(UserVO vo) throws Exception{
         logger.debug("ownerInfoUpdateGET() 호출");
         return aService.userInfoUpdate(vo);
   }
